...
#     pickle.dump(tokenizer, open("rnn_tokenizer.pickle", "wb"))
...
#         print("RNN=", accuracy, precision, recall, fscore)
...
def rnn_model_training():
    ...
    print(f"🎯 RNN Model Metrics: Accuracy={accuracy:.2f}% Precision={precision:.2f}% Recall={recall:.2f}% F1-score={fscore:.2f}%")
    return accuracy, precision, recall, fscore
